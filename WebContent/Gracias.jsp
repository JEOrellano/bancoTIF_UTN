...
<main>
	<div class="conteiner-fluid text-center m-0 p-0">
		<article>
			<div class="row">
				<div class="col-12">
					<section>
					
						<h2> Gracias por visitar el Banco </h2>
						
						<img src="https://img.freepik.com/vector-gratis/manos-sosteniendo-lanzando-billetes-al-aire-hombres-mujeres-ricos-exitosos-que-muestran-ilustraciones-vectoriales-planas-dinero-inversion-finanzas-concepto-emprendedor_74855-24752.jpg?w=1380&t=st=1701016945~exp=1701017545~hmac=d1414719eebdb0d3cd1f5bb4f8508d9d79cc92bacd98beb2d60bf7435005e4d2" alt="Contactos" class="img-fluid" Title="Diferentes medios de contacto" style="width: 400px; height: 200px;" >
